...
// funÃ§Ã£o para filtrar as passagens de frequencias baixas
        ...
        case GAMEPLAY:
        {
          ...
          //checar se a musica tá tocando;
                ...
                if (wave == FIRST){
                    ...
                    if (position.y >= 430)
                        pulou = 0;
                    //MudanÃ§a de nÃ­vel a partir da quantidade de pulos
                    if (level >= 5)
                    {
                        wave = SECOND;
                    }
                    ...
                    // condiÃ§Ã£o de scrolling do background
